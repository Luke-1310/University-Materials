        ...
        echo "<div class=\"nav\">";
            ...
            if(isset($_COOKIE["tema"]) && $_COOKIE["tema"] == "scuro"){
                ...
                echo "<form action=\"res/PHP/tema.php\" method='POST'>";
                    ...
                    echo "<i class=\"dark_mode material-icons\">light_mode</i></button>";
                    echo "<button name=\"bottone_s\" type=\"submit\" value=\"scuro\">";
                    echo "<i class=\"dark_mode material-icons\">dark_mode</i></button>";
                echo "</form>";
            ...
            else
            {
                ...
                echo "<form action = \"res/PHP/tema.php\" method='POST'>";
                    ...
                    echo "<button name=\"bottone_c\" type=\"submit\" value= \"chiaro\">";
                    echo "<i class=\"light_mode material-icons\">light_mode</i></button>";
                    echo "<button name=\"bottone_s\" type=\"submit\" value= \"scuro\">";
                    echo "<i class=\"material-icons\">dark_mode</i></button>";
