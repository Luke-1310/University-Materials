            ...
            <form id="prodottoForm" action = "res/PHP/modifica_offerta.php" method="POST">
                ...
                <div class="titoletto">
                    ...
                    <div class="tooltip">
                        ...
                        <ul>
                            <li>NEL PARAMETRO "HA GIÀ ACQUISTATO" DEVI INSERIRE L'ISBN DI UN FUMETTO CHE L'UTENTE DEVE AVER ACQUISTATO PER FARSÌ CHE SI ATTIVI L'OFFERTA. LASCIALO VUOTO SE NON VUOI UTILIZZARE QUESTO PARAMETRO</li>
